...
import com.example.vitaly.yandexapplication.AsyncTasks.ListLoaderAsync;
...
public class MainActivity extends AppCompatActivity
    ...
    public ListNoteAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        if (savedInstanceState != null) {
          ...
          //  adapter = (ListNoteAdapter) savedInstanceState.getSerializable(ADAPTER);
        }
        ...
        if (savedInstanceState == null) {
         ...
         //   try {
                ...
                ListLoaderAsync listLoaderAsync = new ListLoaderAsync(notes, adapter, databaseHelper);
